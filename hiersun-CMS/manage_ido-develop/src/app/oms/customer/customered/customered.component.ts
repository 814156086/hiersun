...
declare var $: any;
@Component({
  selector: 'app-customered',
  templateUrl: './customered.component.html',
  styleUrls: ['./customered.component.css']
})
export class CustomeredComponent implements OnInit {
  ...
  initCustWorkList() {
    ...
    if(timeSpan){
      params = params
        .set('approvalBeginTime',timeSpan.split("--")[0])
        .set('approvalEndTime',timeSpan.split('--')[1]);
    }

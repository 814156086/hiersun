...
declare var $: any;
@Component({
  selector: 'app-scoredetail',
  templateUrl: './scoredetail.component.html',
  styleUrls: ['./scoredetail.component.css']
})
export class ScoredetailComponent implements OnInit {
  ...
  searchpf(){
    let that = this;
    let listurl = '/oms-admin/reserveorder/visit/getscore?code='+that.code;

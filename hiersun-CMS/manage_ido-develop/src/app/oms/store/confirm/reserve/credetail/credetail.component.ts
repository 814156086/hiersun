...
declare var $: any;
@Component({
  selector: 'app-credetail',
  templateUrl: './credetail.component.html',
  styleUrls: ['./credetail.component.css']
})
export class CredetailComponent implements OnInit {
  ...
  goback() {
    //window.history.go(-1)
    let that = this;
    that.router.navigateByUrl('oms/verify');
  }
  editreserve(){
    let that = this;

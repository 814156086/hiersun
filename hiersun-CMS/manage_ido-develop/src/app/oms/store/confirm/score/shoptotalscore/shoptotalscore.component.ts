...
@Component({
  selector: 'app-shoptotalscore',
  templateUrl: './shoptotalscore.component.html',
  styleUrls: ['./shoptotalscore.component.css']
})
export class ShoptotalscoreComponent implements OnInit {
  opreation:any;
  totalscore:any;
  questionlist:any;
  jiluid:any;

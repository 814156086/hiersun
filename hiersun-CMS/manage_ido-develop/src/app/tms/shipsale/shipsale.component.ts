...
declare var $: any;
@Component({
  selector: 'app-shipsale',
  templateUrl: './shipsale.component.html',
  styleUrls: ['./shipsale.component.css']
})
export class ShipsaleComponent implements OnInit {
  @ViewChild('shipdetail') shipdetail
  ...
  getDelivesMes(delivetyNo) {
    this.shipdetail.initDeliversMes(delivetyNo);
  }
  // 全局弹窗

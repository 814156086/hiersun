...
declare var $: any;
@Component({
	selector: 'app-mgroupcms',
	templateUrl: './mgroupcms.component.html',
	styleUrls: ['./mgroupcms.component.css']
})
export class MgroupcmsComponent implements OnInit {
	pageid:any;
	ispageid=0;
	public list: any;
	public siteId: any;
	...
	ngOnInit() {
		...
		$(".here").on("click", ".setTpl", function () {
			...
			$(this).parents(".template").find("[typeid]").each(function () {
				...
				if (typeid == 1) {//如果是图片
					if ($(this).parents(".interleave").attr("c-data") == 3) {//带小花的图文
						if ($(this).parent("a").length > 0) { //判断img的外面是否含有a标签
							html += '<fieldset class="col-md-12 clearfix filedborder"><legend>更换图片</legend>' +
								...
								'<input type="text" style="width:70%" class="imglink" value="' + $(this).parent("a").attr("href") + '" /><a class="linkchoose"><i class="fa fa-paper-plane"></i></a><a class="deleteval"><i class="fa fa-trash-o"></i></a>' +
								'</div>' +
								'<div class="col-md-2">' +
								'<label class="control-label" style="vertical-align:top;float:left;">背景颜色：</label>' +
								'<span class="bgcolor mycolor" data-toggle="modal" data-target="#myModal" style="border:1px solid #ccc;margin-left:10px;float:left;margin-top:10px;margin-right:10px;display:block;width:20px;height:20px;background:' + $(this).parents(".interleave").css("background") + '"></span>' +
								'</div>' +
								'</div>' +
								'</fieldset>';
						} else {
					...
					if ($(this).parents(".lb-box").attr("c-data") == 2) {
						...
						html += '<fieldset class="col-md-12 clearfix filedborder"><legend>产品标题</legend>' +
							...
							'</div>' +
							'<span class="onecolor mycolor" data-toggle="modal" data-target="#myModal" style="border:1px solid #ccc;margin-left:10px;float:left;margin-top:10px;margin-right:10px;display:block;width:20px;height:20px;background:' + $(this).css("color") + '"></span>' +
							'</div>' +
							'</div>' +
							'<div class="form-group style="position:relative">' +
							'<div class="col-md-10">' +
					...
					var fsize = fontsize.substring(0, fontsize.length - 2);
					//判断是否是轮播图
					if ($(this).parents(".template_lunbo").attr("c-data") == 4) {//手机轮播图
						$(".mshowimgpro").hide();
						$(".mlbtshow").show();
						$(".mlbtshow2").show();
						html += '<fieldset class="col-md-12 clearfix filedborder"><legend>产品描述</legend>' +
							...
							'<input type="text" class="onetitle" style="width:90%" value="' + $(this).text() + '"/>' +
							'</div>' +
							'<span class="twocolor mycolor" data-toggle="modal" data-target="#myModal" style="border:1px solid #ccc;margin-left:10px;float:left;margin-top:10px;margin-right:10px;display:block;width:20px;height:20px;background:' + $(this).css("color") + '"></span>' +
							'</div>' +
							'<div class="col-md-10">' +
							'<label class="control-label" style="width:10%">大小：</label>' +
					...
					if ($(this).css("display") == "block") {
						if ($(this).parent(".series_names").hasClass("conTemplate_right")) {
							html += '<fieldset class="col-md-12 clearfix filedborder"><legend>探索系列</legend>' +
								'<div class="form-group">' +
								'<div class="col-md-4">' +
								'<label class="control-label" style="vertical-align:top">探索按钮：</label>' +
								'<select style="margin-top:8px" class="series">' +
								...
								'</div>' +
								'<div class="col-md-3">' +
								'<label class="control-label" style="vertical-align:top">显示位置：</label>' +
								'<select style="margin-top:8px" class="seriesweizhi">' +
							...
							html += '<fieldset class="col-md-12 clearfix filedborder"><legend>探索系列</legend>' +
								...
								'<div class="col-md-3">' +
								'<label class="control-label" style="vertical-align:top">显示位置：</label>' +
								'<select style="mlbtshows argin-top:8px" class="seriesweizhi">' +
								'<option value="">请选择</option>' +
					...
					if ($(this).find("img").length == 0) {
						html += '<fieldset class="col-md-12 clearfix filedborder"><legend>产品链接：</legend>' +
							...
							'<div class="col-md-4">' +
							'<label class="control-label" style="vertical-align:top">链接：</label>' +
							'<input type="text" class="imglink" value="' + $(this).attr("href") + '" /><a class="linkchoose"><i class="fa fa-paper-plane"></i></a><a class="deleteval"><i class="fa fa-trash-o"></i></a>' +
							'</div>' +
							'</div>' +
							'</fieldset>';
					}
					...
					html += '<fieldset class="col-md-12 clearfix filedborder"><legend>产品链接：</legend>' +
						'<div class="form-group">' +
						'<div class="col-md-12">' +
						'<label class="control-label" style="vertical-align:top">请输入产品链接：</label>' +
						'<input type="text" class="productlink" value="' + $(this).attr("href") + '"/><a class="linkchoose"><i class="fa fa-paper-plane"></i></a><a class="deleteval"><i class="fa fa-trash-o"></i></a>' +
						'</div>' +
						'</div>' +
						'</fieldset>';
				}
				else if (typeid == 8) {//专属定制
					html += '<fieldset class="col-md-12 clearfix filedborder"><legend>产品编码：</legend>' +
						'<div class="form-group">' +
						'<div class="col-md-12">' +
						'<label class="control-label" style="vertical-align:top">请输入商品编码：</label>' +
						'<input type="text" value="' + $("#stylecodedz").val() + '" class="productcode"/>' +
						'</div>' +
						'</div>' +
						'</fieldset>';
				}
				else if (typeid == 9) {//咨询恰客
					html += '<fieldset class="col-md-12 clearfix filedborder"><legend>产品编码：</legend>' +
						'<div class="form-group">' +
						'<div class="col-md-12">' +
						'<label class="control-label" style="vertical-align:top">请输入商品编码：</label>' +
						'<input type="text" value="' + $("#stylecodeqk").val() + '" class="productcodeqk"/>' +
						'</div>' +
						'</div>' +
						'</fieldset>';
			...
			$("#dialog-index").dialog({
				...
				buttons: {
					"确定": function () {
						...
						//探索此系列
						if ($(".series").val() == 1) {
							//var hrefs=$(this).parents(".form-group").find(".serieslink").val();
							...
							that.parents(".template").find(".have_bd").attr("href", $(".serieslink").val()).css("display", "inline-block");
						} else {
							that.parents(".template").find(".go_series").css("display", "none");
							that.parents(".template").find(".have_bd").css("display", "none");
							if ($(".seriesweizhi").val() == "left") {
								that.parents(".template").find(".series_names").removeClass().addClass("series_names conTemplate_left")
							} else if ($(".seriesweizhi").val() == "center") {
								that.parents(".template").find(".series_names").removeClass().addClass("series_names conTemplate_center")
						...
						$(".bgcolor").each(function () {
							...
							that.parents(".template").find(".interleave").css("background", bgcolorvalue)
						})
						//详情页
						...
						if ($(".productcodeqk").val() != "") {
							$("#stylecodeqk").val($(".productcodeqk").val());
							var htmlpro = '<!--#include virtual="/IdoStudio/ntkf/params/' + $(".productcodeqk").val() + '.htm" -->'
							$(".xnkf").html(htmlpro)
						}
						//详情头图上的按钮
		...
		$("#dialog-index").on("click", "button", function () {
			...
			if ($(this).hasClass("mlbtshow")) {
				var html2 = '<div class="form-group">' +
					...
					'<input type="text" class="onefont myfont" data-toggle="modal" data-target="#myModal" value="' + fsize + '"/>px' +
					'</div>' +
					'<div class="col-md-2">' +
					...
					'<div class="col-md-4">' +
					'<div style="float:left"><label class="control-label" style="vertical-align:top">详情：</label>' +
				...
				var lihtml = '<a href="#" target="_blank" class="swiper-slide" typeid="5">' +
					...
					'</div>' +
					'</a>';
			} else if ($(this).hasClass("mlbtshow2")) {
				var html2 = '<div class="form-group">' +
					'<div class="col-md-4">' +
					'<label class="control-label" style="vertical-align:top">图片：</label>' +
					'<img src="https://img.ido-love.com/ido-logo.png" class="slt-pic imgchoose"/>' +
					...
					'</div>' +
					'</div>';
				var lihtml = '<span class="swiper-slide" typeid="10" style="display:block" onclick="NTKF.im_openInPageChat();">' +
					'<img src="" alt="" typeid="1">' +
					'<div class="lb_text">' +
					'<h2 class="first pit_white" typeid="2">I Do TOWER系列</h2>' +
					'<p class="second pit_white" typeid="3">演绎法式浪漫风情</p>' +
			...
			$("#imggroup").dialog({
				...
				buttons: {
					"确定": function () {
						...
						if (thisone.parents(".mmyhtml").find(".mimg_box").find("img").length != 0) {
							thisone.parents(".mmyhtml").find(".mimg_box").find("img").attr("src", activeimgurl)
						} else {
							thisone.parents(".mmyhtml").find(".mimg_box").append("<img src='" + activeimgurl + "'/>")
						}
						$(this).dialog('close');
		...
		//隐藏链接
		$(".here").on("click", ".mcancellink", function () {
		...
		$(".here").on("click", ".maddmylink", function () {
			var link = $(this).parent(".mbtngroup").find("input[name=link]").val();//取得超链接
			var widths = $(this).parent(".mbtngroup").find(".widths").val();
			var heights = $(this).parent(".mbtngroup").find(".heights").val();
			var xiaoneng = $(this).parent(".mbtngroup").find(".methods").val();
			var addview = $(this).parent(".mbtngroup").find(".addview").val();
			var viewimg = $(this).parent(".mbtngroup").find(".viewimg").val();
			var viewval = $(this).parent(".mbtngroup").find(".viewval").val();
			var imgaddress = $(this).parent(".mbtngroup").find(".picadress").val();
			var linkadress = $(this).parent(".mbtngroup").find(".linkadress").val();

			if (xiaoneng == 1) {//链接到小能
				var html =
					'<p class="mmaodian kefuer" style="width:' + widths + '%;height:' + heights + '%;">' +
					'<a class="template_try" style="width:100%;height:100%">' +
					'</a></p>';//组装P标签
			} else if (xiaoneng == 0) {//链接到网址
				var html =
					'<p class="mmaodian webadress" style="width:' + widths + '%;height:' + heights + '%;">' +
					'<a target="_blank" href="' + link + '" style="width:100%;height:100%">' +
					'</a></p>';//组装P标签
			} else if (xiaoneng == 2) { //链接到视频
				var html =
					'<p class="mmaodian viewweb" style="width:' + widths + '%;height:' + heights + '%;">' +
					'<img src="' + viewimg + '" alt="" class="addImg lazy" style="width:100%;height:100%">' +
					'<video src="' + viewval + '" style="object-fit:fill;display:none" width="100%" height="100%" controls="controls" class="adVideo"></video>' +
					'</p>'
			} else { //链接到图片
				var html =
					'<p class="mmaodian picter" style="width:' + widths + '%;height:' + heights + '%;">' +
					'<a target="_blank" href="' + linkadress + '" style="width:100%;height:100%;">' +
					'<img src="' + imgaddress + '" alt="" class="addImg lazy" style="width:100%;">' +
					'</a>' +
					'</p>'
			}
		...
		$("#mhere").delegate(".mmaodian", "mousedown", function (e) {
			...
			$(".widths").val(_w[0] / 375 * 100);
			$(".heights").val(_h[0] / 375 * 100);
			// console.log($(".heights").val())
			if (obj.hasClass("kefuer")) {//客服
				obj.parents(".mmyhtml").find(".methods").val("1");
				$(".imgaddress").hide();
				$('.viewsp').hide();
				$('.weblink').hide();
			}
			if (obj.hasClass("webadress")) {//网址
				obj.parents(".mmyhtml").find(".methods").val("0");
				obj.parents(".mmyhtml").find(".linkval").val(obj.find("a").attr("href"));
				$(".imgaddress").hide();
				$('.viewsp').hide();
				$('.weblink').show();
			}
			if (obj.hasClass("viewweb")) {//视频
				obj.parents(".mmyhtml").find(".methods").val("2");
				obj.parents(".mmyhtml").find(".viewimg").val(obj.find("img").attr("src"));
				obj.parents(".mmyhtml").find(".viewval").val(obj.find("video").attr("src"));
				$(".imgaddress").hide();
				$('.viewsp').show();
				$('.weblink').hide();
			}
			if (obj.hasClass("picter")) {//图片
				obj.parents(".mmyhtml").find(".methods").val("3");
				obj.parents(".mmyhtml").find(".picadress").val(obj.find("img").attr("src"));
				obj.parents(".mmyhtml").find(".linkadress").val(obj.find("a").attr("href"));
				$(".imgaddress").show();
				$('.viewsp').hide();
				$('.weblink').hide();
			}
		...
		$(window).scroll(function () {
			if ($(document).scrollTop() > $(".modelstemplate").offset().top) {
				...
				$(".fullpage").css("margin-left", "34%")
			}
			if ($(document).scrollTop() < 200) {
				$(".modelstemplate").removeClass("leftfiexed");
				$(".fullpage").css("margin-left", "4%")
			}
		})
		var that = this;
		...
		if (this.id) {
			...
			this.http.get(url).subscribe(
				function (data) {
					...
					/* if (document.querySelector(".dingzhi_btn")) {
						$(".stylecode").val(decodeURIComponent(that.pagemsg.productCode));
					} */
					console.log(decodeURIComponent(that.pagemsg.productCode))
					if ($(".here").find("#stylecodedz")) {
						console.log("dingzhi123")
						$("#stylecodedz").val(decodeURIComponent(that.pagemsg.productCode));
					}
					if ($(".here").find("#stylecodeqk")) {
						console.log("qiake")
						$("#stylecodeqk").val(decodeURIComponent(that.pagemsg.productCode));
					}
					...
					$(".interleave").each(function (index, item) {
						if (parseInt(index) % 2 == 0) {//偶数
							$(this).css("background", "#fff")
						} else {
							$(this).css("background", "#f8f8f8")
						}
					})
					$(".edithtml").find(".mfixedbtn").show();
					$(".edithtml .mmaodian").css({ "background": "#000", "opacity": "0.4" });
	...
	tmpzcsave(status) {
		...
		$(".here").find(".mfixedbtn").hide();
		$(".here").find(".mbtngroup").hide();
		$(".here .mmaodian").css("background", "none");
		if ($(".here .mmaodian").find("img").hasClass("maddImg")) {
			$(".here .mmaodian").css("opacity", "1");
		}
		...
		if ($(".template").find(".dingzhi_btn").attr("typeid") == "8") {
			console.log($("#stylecodedz").val())
			this.page.productCode = $("#stylecodedz").val();
		}
		if ($(".template").find(".dingzhi_btn").attr("typeid") == "9") {
			console.log($("#stylecodeqk").val())
			this.page.productCode = $("#stylecodeqk").val();
		}
		console.log(this.page.productCode)
		this.http.post(url, this.page).subscribe(function (data) {
			if (data['header'].code == 200) {
				...
				if (status == 1) {
					...
					history.replaceState(null, null, "/cms/mgroupcms?siteId=" + data['body'].siteId + "&id=" + data['body'].id + "&channelId=" + data['body'].channelId)
	...
	preview(status) {
		...
		if ($(".dingzhi_btn").attr("typeid") == 8) {
			this.page.productCode = $("#stylecodedz").val();
		}
		if ($(".dingzhi_btn").attr("typeid") == 9) {
			this.page.productCode = $("#stylecodeqk").val();
		}
		console.log(this.page.productCode)
		this.http.post(url, this.page).subscribe(function (data) {
	...
	selectpic(e) {
		if ($(".imgchoose").hasClass("selectimgs")) {
			...
			var activeimgurl = $(".activeborder").find("img").attr("src");
			if ($(".myimgs").parents(".mmyhtml").find(".mimg_box").find("img").length != 0) {
				//console.log("1111")
				$(".myimgs").parents(".mmyhtml").find(".mimg_box").find("img").attr("src", activeimgurl)
			} else {
				//console.log("222")
				$(".myimgs").parents(".mmyhtml").find(".mimg_box").append("<img src='" + activeimgurl + "'/>")
			}
			$("#imggroup").dialog('close');
			$(".meditpic").removeClass("myimgs");
		}
